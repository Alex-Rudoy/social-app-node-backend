...
export default class Search {
  constructor() {
    ...
    this.overlayCloseIcon = document.querySelector(".close-live-search");
  ...
  events() {
    ...
    this.overlayCloseIcon.addEventListener("click", (e) => {
        ...
        ${posts
          .map((post) => {
            ...
            return `<a href="/post/${post._id}" class="list-group-item list-group-item-action">
              ...
              <span class="text-muted small">by ${post.author.username} on ${postDate.toLocaleDateString()}</span>
            </a>`;
          })
          .join("")}
      </div>
